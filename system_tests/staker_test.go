...
import (
	...
	"github.com/tenderly/stylus/solgen/go/rollupgen"
	"github.com/tenderly/stylus/staker"
	"github.com/tenderly/stylus/util"
...
func stakerTestImpl(t *testing.T, faultyStaker bool, honestStakerInactive bool) {
	...
	_, l2nodeA, l2clientA, _, l1info, _, l1client, l1stack := createTestNodeOnL1WithConfigImpl(t, ctx, true, nil, l2chainConfig, nil, nil, l2info)
