...
// SetWasmMinInitGas is a paid mutator transaction binding the contract method 0xec896432.
//
// Solidity: function setWasmMinInitGas(uint16 gas) returns()
func (_ArbOwner *ArbOwnerTransactor) SetWasmMinInitGas(opts *bind.TransactOpts, gas uint16) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setWasmMinInitGas", gas)
}

// SetWasmMinInitGas is a paid mutator transaction binding the contract method 0xec896432.
//
// Solidity: function setWasmMinInitGas(uint16 gas) returns()
func (_ArbOwner *ArbOwnerSession) SetWasmMinInitGas(gas uint16) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmMinInitGas(&_ArbOwner.TransactOpts, gas)
}

// SetWasmMinInitGas is a paid mutator transaction binding the contract method 0xec896432.
//
// Solidity: function setWasmMinInitGas(uint16 gas) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetWasmMinInitGas(gas uint16) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmMinInitGas(&_ArbOwner.TransactOpts, gas)
}
...
// SetWasmPageRamp is a paid mutator transaction binding the contract method 0xd0029047.
//
// Solidity: function setWasmPageRamp(uint64 ramp) returns()
func (_ArbOwner *ArbOwnerTransactor) SetWasmPageRamp(opts *bind.TransactOpts, ramp uint64) (*types.Transaction, error) {
	return _ArbOwner.contract.Transact(opts, "setWasmPageRamp", ramp)
}

// SetWasmPageRamp is a paid mutator transaction binding the contract method 0xd0029047.
//
// Solidity: function setWasmPageRamp(uint64 ramp) returns()
func (_ArbOwner *ArbOwnerSession) SetWasmPageRamp(ramp uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmPageRamp(&_ArbOwner.TransactOpts, ramp)
}

// SetWasmPageRamp is a paid mutator transaction binding the contract method 0xd0029047.
//
// Solidity: function setWasmPageRamp(uint64 ramp) returns()
func (_ArbOwner *ArbOwnerTransactorSession) SetWasmPageRamp(ramp uint64) (*types.Transaction, error) {
	return _ArbOwner.Contract.SetWasmPageRamp(&_ArbOwner.TransactOpts, ramp)
}
...
//
// Solidity: function minInitGas() view returns(uint16 gas)
func (_ArbWasm *ArbWasmCaller) MinInitGas(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
...
//
// Solidity: function minInitGas() view returns(uint16 gas)
func (_ArbWasm *ArbWasmSession) MinInitGas() (uint16, error) {
...
//
// Solidity: function minInitGas() view returns(uint16 gas)
func (_ArbWasm *ArbWasmCallerSession) MinInitGas() (uint16, error) {
	return _ArbWasm.Contract.MinInitGas(&_ArbWasm.CallOpts)
}
...
//
// Solidity: function programInitGas(address program) view returns(uint32 gas)
func (_ArbWasm *ArbWasmCaller) ProgramInitGas(opts *bind.CallOpts, program common.Address) (uint32, error) {
	var out []interface{}
...
//
// Solidity: function programInitGas(address program) view returns(uint32 gas)
func (_ArbWasm *ArbWasmSession) ProgramInitGas(program common.Address) (uint32, error) {
...
//
// Solidity: function programInitGas(address program) view returns(uint32 gas)
func (_ArbWasm *ArbWasmCallerSession) ProgramInitGas(program common.Address) (uint32, error) {
	return _ArbWasm.Contract.ProgramInitGas(&_ArbWasm.CallOpts, program)
}
