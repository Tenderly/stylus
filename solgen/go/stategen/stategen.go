...
var DeserializeMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
...
// GuardStackLibMetaData contains all meta data concerning the GuardStackLib contract.
var GuardStackLibMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}

// GuardStackLibABI is the input ABI used to generate the binding from.
// Deprecated: Use GuardStackLibMetaData.ABI instead.
var GuardStackLibABI = GuardStackLibMetaData.ABI

// GuardStackLibBin is the compiled bytecode used for deploying new contracts.
// Deprecated: Use GuardStackLibMetaData.Bin instead.
var GuardStackLibBin = GuardStackLibMetaData.Bin

// DeployGuardStackLib deploys a new Ethereum contract, binding an instance of GuardStackLib to it.
func DeployGuardStackLib(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *GuardStackLib, error) {
	parsed, err := GuardStackLibMetaData.GetAbi()
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	if parsed == nil {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(GuardStackLibBin), backend)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
	return address, tx, &GuardStackLib{GuardStackLibCaller: GuardStackLibCaller{contract: contract}, GuardStackLibTransactor: GuardStackLibTransactor{contract: contract}, GuardStackLibFilterer: GuardStackLibFilterer{contract: contract}}, nil
}

// GuardStackLib is an auto generated Go binding around an Ethereum contract.
type GuardStackLib struct {
	GuardStackLibCaller     // Read-only binding to the contract
	GuardStackLibTransactor // Write-only binding to the contract
	GuardStackLibFilterer   // Log filterer for contract events
}

// GuardStackLibCaller is an auto generated read-only Go binding around an Ethereum contract.
type GuardStackLibCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// GuardStackLibTransactor is an auto generated write-only Go binding around an Ethereum contract.
type GuardStackLibTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// GuardStackLibFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type GuardStackLibFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// GuardStackLibSession is an auto generated Go binding around an Ethereum contract,
// with pre-set call and transact options.
type GuardStackLibSession struct {
	Contract     *GuardStackLib    // Generic contract binding to set the session for
	CallOpts     bind.CallOpts     // Call options to use throughout this session
	TransactOpts bind.TransactOpts // Transaction auth options to use throughout this session
}

// GuardStackLibCallerSession is an auto generated read-only Go binding around an Ethereum contract,
// with pre-set call options.
type GuardStackLibCallerSession struct {
	Contract *GuardStackLibCaller // Generic contract caller binding to set the session for
	CallOpts bind.CallOpts        // Call options to use throughout this session
}

// GuardStackLibTransactorSession is an auto generated write-only Go binding around an Ethereum contract,
// with pre-set transact options.
type GuardStackLibTransactorSession struct {
	Contract     *GuardStackLibTransactor // Generic contract transactor binding to set the session for
	TransactOpts bind.TransactOpts        // Transaction auth options to use throughout this session
}

// GuardStackLibRaw is an auto generated low-level Go binding around an Ethereum contract.
type GuardStackLibRaw struct {
	Contract *GuardStackLib // Generic contract binding to access the raw methods on
}

// GuardStackLibCallerRaw is an auto generated low-level read-only Go binding around an Ethereum contract.
type GuardStackLibCallerRaw struct {
	Contract *GuardStackLibCaller // Generic read-only contract binding to access the raw methods on
}

// GuardStackLibTransactorRaw is an auto generated low-level write-only Go binding around an Ethereum contract.
type GuardStackLibTransactorRaw struct {
	Contract *GuardStackLibTransactor // Generic write-only contract binding to access the raw methods on
}

// NewGuardStackLib creates a new instance of GuardStackLib, bound to a specific deployed contract.
func NewGuardStackLib(address common.Address, backend bind.ContractBackend) (*GuardStackLib, error) {
	contract, err := bindGuardStackLib(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &GuardStackLib{GuardStackLibCaller: GuardStackLibCaller{contract: contract}, GuardStackLibTransactor: GuardStackLibTransactor{contract: contract}, GuardStackLibFilterer: GuardStackLibFilterer{contract: contract}}, nil
}

// NewGuardStackLibCaller creates a new read-only instance of GuardStackLib, bound to a specific deployed contract.
func NewGuardStackLibCaller(address common.Address, caller bind.ContractCaller) (*GuardStackLibCaller, error) {
	contract, err := bindGuardStackLib(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
	return &GuardStackLibCaller{contract: contract}, nil
}

// NewGuardStackLibTransactor creates a new write-only instance of GuardStackLib, bound to a specific deployed contract.
func NewGuardStackLibTransactor(address common.Address, transactor bind.ContractTransactor) (*GuardStackLibTransactor, error) {
	contract, err := bindGuardStackLib(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
	return &GuardStackLibTransactor{contract: contract}, nil
}

// NewGuardStackLibFilterer creates a new log filterer instance of GuardStackLib, bound to a specific deployed contract.
func NewGuardStackLibFilterer(address common.Address, filterer bind.ContractFilterer) (*GuardStackLibFilterer, error) {
	contract, err := bindGuardStackLib(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &GuardStackLibFilterer{contract: contract}, nil
}

// bindGuardStackLib binds a generic wrapper to an already deployed contract.
func bindGuardStackLib(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := GuardStackLibMetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_GuardStackLib *GuardStackLibRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _GuardStackLib.Contract.GuardStackLibCaller.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_GuardStackLib *GuardStackLibRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _GuardStackLib.Contract.GuardStackLibTransactor.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_GuardStackLib *GuardStackLibRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _GuardStackLib.Contract.GuardStackLibTransactor.contract.Transact(opts, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_GuardStackLib *GuardStackLibCallerRaw) Call(opts *bind.CallOpts, result *[]interface{}, method string, params ...interface{}) error {
	return _GuardStackLib.Contract.contract.Call(opts, result, method, params...)
}

// Transfer initiates a plain transaction to move funds to the contract, calling
// its default method if one is available.
func (_GuardStackLib *GuardStackLibTransactorRaw) Transfer(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _GuardStackLib.Contract.contract.Transfer(opts)
}

// Transact invokes the (paid) contract method with params as input values.
func (_GuardStackLib *GuardStackLibTransactorRaw) Transact(opts *bind.TransactOpts, method string, params ...interface{}) (*types.Transaction, error) {
	return _GuardStackLib.Contract.contract.Transact(opts, method, params...)
}

// InstructionsMetaData contains all meta data concerning the Instructions contract.
var InstructionsMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
...
var MachineLibMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
...
var MerkleProofLibMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
...
var ModuleLibMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
...
var ModuleMemoryLibMetaData = &bind.MetaData{
	ABI: "[]",
	Bin: "",
}
